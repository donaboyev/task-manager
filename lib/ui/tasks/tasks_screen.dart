        ...
        builder: (tasksController) => Scaffold(
          ...
          appBar: !tasksController.isSearching
              ? AppBar(
                  backgroundColor: clrWhite,
                  elevation: 0,
                  title: const Text('Tasks', style: styActionAppbar),
                  actions: [
                    IconButton(
                      icon: const Icon(Icons.search, color: clrAccent),
                      onPressed: () => tasksController.setIsSearching(true),
                    ),
                    PopupMenuButton<String>(
                      tooltip: 'Sorting types',
                      icon: const Icon(Icons.sort, color: clrAccent),
                      itemBuilder: (context) {
                        return {
              ...
              : SearchAppBarWidget(
                  onChanged: (value) {
                    ...
                    tasksController.isClearButtonEnabled(
                      tasksController.searchController!.text.trim().isNotEmpty,
                    );
                  },
                  onLeadingTap: () async {
